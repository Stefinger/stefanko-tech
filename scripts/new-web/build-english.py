...
def replace_exactly(text, old, new, what):
    if text.count(old) != 1:
        raise ValueError(f'{what}: expected exactly one occurrence of {old!r}')
...
(PUBLIC / 'en-story.js').write_text(
    ...
    encoding='utf-8')
print('English page and interactive copy generated; Czech residue and route checks passed.')
